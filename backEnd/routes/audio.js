...
//     try {
//         const newAudio= {};
//          if(title){newAudio.title= title};
//          if(description){newAudio.description= description};
//          if(tag){newAudio.tag= tag};
...
//          }
//           audio = await Audio.findByIdAndUpdate(req.params.id, {$set: newAudio}, {new:true})
//           res.json(audio)
